...
SECRET_KEY = 'django-insecure-v+xsb^z825#6#vjgrrzj!^464=^!hpn!)v%b(qhxkib4*!5o1j'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # This directory will store your uploaded media files
...
LOGOUT_REDIRECT_URL = 'main:main_page'  # Redirect to 'main_page' after logout
